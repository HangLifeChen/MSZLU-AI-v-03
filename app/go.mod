...
require (
	...
	github.com/cloudwego/eino-examples v0.0.0-20260303032229-cdc720df8c98
	...
	github.com/cloudwego/eino-ext/components/document/parser/html v0.0.0-20260305011506-a75910204c1f
